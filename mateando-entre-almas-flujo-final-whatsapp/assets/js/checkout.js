  ...
  if (method === "mercadopago") {
    statusBox.innerHTML = `
      <div class="status-card success">
        ...
        <p>Completá tus datos de envío. Al confirmar, se enviará el pedido por WhatsApp y se preparará una copia por email.</p>
        <p>Si abonaste o generaste cupón en MercadoPago, el vendedor verificará el pago antes del despacho.</p>
      </div>
    `;
  }
}
